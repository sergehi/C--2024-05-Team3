...
var __TURBOPACK__imported__module__$5b$project$5d2f$site$2f$services$2f$authService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/site/services/authService.ts [app-route] (ecmascript)");
...
const providers = [
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$site$2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
        ...
        async authorize (credentials) {
            ...
            try {
                const user = await __TURBOPACK__imported__module__$5b$project$5d2f$site$2f$services$2f$authService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].login(credentials.userName, credentials.password);
                if (user) {
                    return {
                        id: user.id,
                        name: user.name,
...
//# sourceMappingURL=%5Bproject%5D_site_609aaf._.js.map